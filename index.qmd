...
# F1tenth: invincible_proj {.title}

::: {.subtitle}
Time Trial ECE484 final project
:::

::: {.author-list}

[**Zhenyu Zhang**](https://example.com)^1^,
[**Yuanzhe Wang**](https://example.com)^2^,
[**Murphy Huang**](https://example.com)^1,2^

:::

::: {.affiliation-list}

^1^University of Illinois Urbana-Champaign,  ^2^ECE484
...
[[{{< fa brands github >}} Code]{.btn-text}](https://github.com/safeautonomy-illinois-students/project-site-invincible_proj/){.btn .btn-primary}
